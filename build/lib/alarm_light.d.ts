 ...
 */
export declare function buildLedGroupBrightnessUpdate(current: LightingState, groupKey: "topLedLightSettings" | "bottomLedLightSettings", brightness: number): LightingState;
/**
