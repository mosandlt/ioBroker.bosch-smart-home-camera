 ...
 */
export function buildFrontLightUpdate(current: LightingState, brightness: number): LightingState {
    return {
        frontLightSettings: {
 ...
 */
export function buildLedGroupBrightnessUpdate(
 ...
 */
export function buildFrontLightWhiteBalanceUpdate(
    current: LightingState,
    whiteBalance: number,
): LightingState {
    return {
